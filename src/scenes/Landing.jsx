...
const Landing = ({ setSelectedPage}) => {
    ...
    return (
        <section id="home" className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10">
            ...
            {/* IMAGE SECTION this comes first even though it is to the right of the text because we want the image n top of the texton smaller screens*/}
            ...
            <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
                {isAboveMediumScreens ? (
                    <div className="relative z-0 ml-20 before:absolute before:-top-20 before:-left-20
                        ...
                        <img alt="profile" src={profileImage} className="hover:filter hover:saturate-200 transition duration-500 z-10 w-full
                ...
                {/*HEADINGS */}
                    ...
                    variants={{hidden: { opacity: 0, x: -50}, visible: { opacity: 1, x: 0}}}>
                        ...
                        <p className="mt-10 mb-7 text-sm text-center md:text-start">
                            Senior Computer Science student at University of Massachusetts - Lowell
                        </p>
                    </motion.div>

                    <motion.div className="flex mt-5 justify-center md:justify-start" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} transition={{delay: 0.2, duration: 0.5}}
                    variants={{hidden: { opacity: 0, x: -50}, visible: { opacity: 1, x: 0}}}>
                        <AnchorLink className="bg-gradient-rainblue text-deep-blue rounded-l-sm py-3 px-7 font-semibold hover:bg-blue hover:text-white
                            transition duration-500" onClick = {() => setSelectedPage("contact")} href="#contact">
                            Contact Me
                        </AnchorLink>
